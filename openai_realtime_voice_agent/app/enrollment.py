...
ENROLLMENT_SCRIPT = (
    ...
    "silently and do not skip any. "
    "(2) Ask for FOUR said quickly and casually, as if walking past. "
    "(3) Ask for FOUR said lazily, quietly, or mumbled. "
    "(4) Ask them to stand across the room and give SIX louder ones from there, "
    "a couple of them while moving around. "
    "(5) Ask for THREE more however they fancy — annoyed, amused, half-asleep. "
    "That is twenty-five repetitions in total; if you lost count, do a few extra "
    "rather than a few short. "
    "(6) Ask them to speak normally for about NINETY seconds — describe their day, "
    "read anything nearby, or ramble; encourage them briefly whenever they stop "
    "before time is up. "
    ...
    "session in another room sharpens things further. If they want to pause or the "
    "session drops, they can wake you again and say 'continue voice training' — "
    "start a fresh session with the same name. Do not chat, do not explain the "
    "technology, do not comment on their performance beyond the brief prompts."
)
